...
hl.common = {
    ...
    PmenuSel = {fg = c.bg0, bg = c.dark_blue},
    WildMenu = {fg = c.bg0, bg = c.blue},
    PmenuThumb = {fg = c.none, bg = c.grey},
    Question = {fg = c.yellow},
    SpellBad = {fg = c.dark_red, fmt = "underline", sp = c.dark_red},
    SpellCap = {fg = c.yellow, fmt = "underline", sp = c.yellow},
    SpellLocal = {fg = c.cyan, fmt = "underline", sp = c.cyan},
    ...
    QuickFixLine = {fg = c.dark_blue, fmt = "underline"},
    Debug = {fg = c.yellow},
    debugPC = {fg = c.bg0, bg = c.green},
    debugBreakpoint = {fg = c.bg0, bg = c.dark_red},
    ToolbarButton = {fg = c.bg0, bg = c.dark_blue},
