...
hl.common = {
    ...
    DiffDelete = {fg = c.none, bg = c.dark_brown2},
    DiffText = {fg = c.none, bg = c.dark_blue3},
    DiffAdded = {fg = c.bright_green},
    DiffRemoved = {fg = c.bright_red},
    DiffFile = {fg = c.dark_blue2},
    ...
    SpellBad = {fg = c.light_red2, fmt = "underline", sp = c.light_red2},
    ...
    debugBreakpoint = {fg = c.bg0, bg = c.light_red2},
